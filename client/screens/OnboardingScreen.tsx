...
const BUSINESS_TYPES: BusinessType[] = [
  ...
  { id: "medical", name: "Medical", icon: "heart", color: "#3B82F6" },
  { id: "dental", name: "Dental", icon: "smile", color: "#3B82F6" },
  { id: "veterinary", name: "Veterinary", icon: "heart", color: "#10B981" },
  { id: "automotive", name: "Auto Detailing", icon: "truck", color: "#F59E0B" },
  { id: "fitness", name: "Fitness", icon: "zap", color: "#10B981" },
  { id: "yoga", name: "Yoga Studios", icon: "sun", color: "#8B5CF6" },
  { id: "tattoo", name: "Tattoo Studios", icon: "edit-2", color: "#EF4444" },
  { id: "massage", name: "Massage Therapy", icon: "feather", color: "#EC4899" },
  { id: "photography", name: "Photography", icon: "camera", color: "#6366F1" },
  { id: "tutoring", name: "Tutoring", icon: "book", color: "#F59E0B" },
  { id: "consulting", name: "Consulting", icon: "briefcase", color: "#8B5CF6" },
  { id: "coaching", name: "Coaching", icon: "award", color: "#14B8A6" },
  { id: "cleaning", name: "Cleaning", icon: "star", color: "#10B981" },
  { id: "plumber", name: "Plumbing", icon: "droplet", color: "#3B82F6" },
  { id: "electrician", name: "Electrical", icon: "battery-charging", color: "#F59E0B" },
